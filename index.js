...
// Secret de session et JWT
const sessionSecret = process.env.SESSION_SECRET || 'your_secret_key'; // Utilisation de la variable d'environnement ou valeur par défaut
const jwtSecret = process.env.JWT_SECRET || 'secret_ecom'; // Utilisation de la variable d'environnement ou valeur par défaut

// Session Middleware Setup
app.use(session({
    secret: sessionSecret, // Utilisation de la variable d'environnement ou valeur par défaut
    resave: false,
...
// Authentification avec Passport (ajouter une stratégie locale si nécessaire)
...
// Remplacer les tokens JWT par la variable d'environnement
const token = jwt.sign(data, jwtSecret); // Utilisation de la variable d'environnement
